...
import make_student_dashboard
import make_company_dashboard
from flask import render_template
from model import db, Company, Application
from make_homepage import make_homepage
...
make_student_dashboard.make_dashboard(app)
make_company_dashboard.make_dashboard(app)
